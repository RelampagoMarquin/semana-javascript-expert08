import isSuported from './isSupported.js'
...
export default class VideoProcessor {
     ...
     * @param {import('../deps/webm-writer2.js').default} options.webWriter
     * @param {import('./service.js').default} options.service
     */
    constructor({ mp4Demuxer, webWriter, service }) {
    ...
    transformIntoWebM(){
        ...
        return {
            readable: this.#webWriter.getStream(),
            writable
        }
    }
